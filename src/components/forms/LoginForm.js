    ...
    return(
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className='mb-3'>
                ...
                />
                {/* mensagem de validação do campo 'email' */}
                {
            ...
            <div className='mb-3'>
                ...
                {/* mensagem de validação do campo 'senha' */}
                {
